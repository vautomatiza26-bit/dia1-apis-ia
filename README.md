...
Migra los datos de facturas de CSV a una base de datos **SQLite**, con esquema tipado y control de duplicados. Es un script que se ejecuta una sola vez para generar la base de datos, no algo que corra en cada petición del agente.
